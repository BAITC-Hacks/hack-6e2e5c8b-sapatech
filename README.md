...
интеграция `f95a8e3` проверена в отдельной локальной копии, без переноса
...
Для опубликованной интеграции `f95a8e3` те же проверки выполнены с
`<staged>/agent.py` и `strategy/` в отдельной копии пакета. Точные команды,
коммит и измерения приведены в
[отчёте интеграции](docs/evaluation/integrated-f95a8e3.md).
